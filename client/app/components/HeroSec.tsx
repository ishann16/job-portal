...
export default function HeroSec(){
    ...
    <main className="flex flex-col  justify-between p-8">
        ...
        <Image src="/background.jpeg" alt="background image" height={400} width={900} style={{ borderRadius: '30px' }} />
    </div>
        ...
        <div className="flex flex-col items-center justify-between">
            <form className="flex-col items-center justify-between w-[700px] relative bg-white">
                <div className="flex border-[2px] rounded-full ">
                    ...
                    <input type="search" placeholder="Job title, keyword, or company" className="rounded-full w-[500px] h-full border-none p-4"></input>
            ...
            <p style={{ paddingTop: "15px", justifyContent:"left"}}>
                You can also <strong>Post a job</strong> or <strong>Post your resume </strong> 
            </p>
        </div>

        <p style={{paddingTop:"15px", paddingBottom:"15px", marginLeft:"100px"}}> Suggested jobs for you  </p>
        ...
        <p style={{paddingTop:"15px", marginLeft:"100px"}}> Recommended for you</p>
